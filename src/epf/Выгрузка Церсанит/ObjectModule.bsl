...
Функция mxrest(Запрос, Знач СтруктПараметров)
	...
	ТекстЗапроса = "ВЫБРАТЬ
	               ...
	               |	ВложенныйЗапрос.in_qty,
	               |	ВложенныйЗапрос.out_qty,
	               |	ВложенныйЗапрос.end_rest,
	               |	ВЫБОР
	               |		КОГДА &ВыгружатьВсе
	               ...
	               |			ЕСТЬNULL(ПартииТоваровНаСкладахОбороты.КоличествоПриход, 0) КАК КоличествоПриход,
	               |			ЕСТЬNULL(ПартииТоваровНаСкладахОбороты.КоличествоРасход, 0) КАК КоличествоРасход,
	               |			ЕСТЬNULL(ВложенныйЗапрос.КоличествоКонечныйОстаток, 0) КАК КоличествоКонечныйОстаток,
	               |			ЕСТЬNULL(ПартииТоваровНаСкладахОбороты.СтоимостьРасход, 0) КАК СтоимостьРасход,
	               ...
	               |				ПОЛНОЕ СОЕДИНЕНИЕ РегистрНакопления.ПартииТоваровНаСкладах.Обороты(&ДатаНач, &ДатаКон, , Номенклатура В ИЕРАРХИИ (&Номенклатура)) КАК ПартииТоваровНаСкладахОбороты
	               ...
	               |					И ВложенныйЗапрос.ДокументОприходования = ПартииТоваровНаСкладахОбороты.ДокументОприходования) КАК взДанные) КАК ВложенныйЗапрос";
